...
pub struct Function {
    ...
    pub(super) saved_regs: SaveRegList<Amd64Reg>,
    /// Number of 8-byte stack slots to be reserved in the activation record.
    /// Only valid during gen_code
    pub(super) num_stackslots: usize,
...
impl Function {
    ...
    pub(super) fn gen_code(&mut self, graph: Ptr<lir::BlockGraph>) {
        ...
        self.num_stackslots = lsa.stack_vars_counter;
