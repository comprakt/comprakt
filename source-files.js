...
sourcesIndex['compiler_lib'] = {"name":"","dirs":[{"name":"linter","dirs":[{"name":"lints","dirs":[],"files":["bools.rs","mod.rs","too_many_arguments.rs","unused_arguments.rs","unused_class.rs","unused_fields.rs","unused_functions.rs"]}],"files":["lint_level_builder.rs","locator.rs","mod.rs"]},{"name":"print","dirs":[],"files":["mod.rs","pretty.rs","structure.rs"]}],"files":["backend.rs","firm_context.rs","lib.rs"]};
sourcesIndex['compiler_shared'] = {"name":"","dirs":[],"files":["context.rs","lib.rs","timing.rs"]};
...
sourcesIndex['diagnostics'] = {"name":"","dirs":[],"files":["diagnostics.rs","lint.rs"]};
...
sourcesIndex['gcollections'] = {"name":"","dirs":[{"name":"ops","dirs":[],"files":["associative.rs","bounded.rs","cardinality.rs","constructor.rs","lattice.rs","mod.rs","multiset.rs","sequence.rs","set.rs"]},{"name":"wrappers","dirs":[],"files":["bit_set.rs","btree_set.rs","hash_set.rs","mod.rs","optional.rs","primitives.rs","vector.rs","vector_deque.rs"]}],"files":["kind.rs","lib.rs","macros.rs","queue.rs","stack.rs"]};
...
sourcesIndex['interval'] = {"name":"","dirs":[],"files":["interval.rs","interval_set.rs","lib.rs","ops.rs"]};
...
sourcesIndex['log'] = {"name":"","dirs":[],"files":["lib.rs","macros.rs"]};
sourcesIndex['lowering'] = {"name":"","dirs":[{"name":"lir","dirs":[],"files":["debugging.rs","gen_instr.rs"]},{"name":"peephole","dirs":[],"files":["binop.rs","jmp_targets.rs","mov.rs"]}],"files":["allocator.rs","basic_block_scheduling.rs","codegen.rs","cycle_removal.rs","lib.rs","linear_scan.rs","lir.rs","live_variable_analysis.rs","peephole.rs","register.rs"]};
...
sourcesIndex['optimization'] = {"name":"","dirs":[{"name":"analysis","dirs":[],"files":["mod.rs"]},{"name":"lattices","dirs":[],"files":["heap.rs","mem.rs","mod.rs"]}],"files":["code_placement.rs","common_subexpr_elim.rs","compile_time_assertions.rs","constant_folding.rs","constant_folding_load_store.rs","control_flow.rs","inlining.rs","lib.rs","node_local.rs","remove_critical_edges.rs"]};
...
sourcesIndex['shell_words'] = {"name":"","dirs":[],"files":["lib.rs"]};
...
sourcesIndex['trilean'] = {"name":"","dirs":[],"files":["lib.rs","skleene.rs"]};
