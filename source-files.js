...
sourcesIndex['compiler_lib'] = {"name":"","dirs":[{"name":"linter","dirs":[{"name":"lints","dirs":[],"files":["bools.rs","mod.rs","unused_arguments.rs","unused_class.rs","unused_fields.rs","unused_functions.rs"]}],"files":["lint_level_builder.rs","locator.rs","mod.rs"]},{"name":"print","dirs":[],"files":["mod.rs","pretty.rs","structure.rs"]}],"files":["backend.rs","firm_context.rs","lib.rs"]};
...
sourcesIndex['log'] = {"name":"","dirs":[],"files":["lib.rs","macros.rs"]};
sourcesIndex['lowering'] = {"name":"","dirs":[{"name":"lir","dirs":[],"files":["debugging.rs","gen_instr.rs"]}],"files":["allocator.rs","basic_block_scheduling.rs","codegen.rs","cycle_removal.rs","lib.rs","linear_scan.rs","lir.rs","live_variable_analysis.rs","register.rs"]};
